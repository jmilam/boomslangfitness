Rails.application.routes.draw do
  ...
  get 'store', to: 'stand_alone_store#index', as: 'stand_alone_store'
  post 'stand_alone_store/process_payment', to: 'stand_alone_store#process_payment', as: 'stand_alone_process_payment'
  get 'stand_alone_store/purchase', to: 'stand_alone_store#purchase', as: 'stand_alone_purchase'
  post 'stand_alone_store/register', to: 'stand_alone_store#register', as: 'stand_alone_register'
  ...
  resources :workout_class, only: [:index, :create, :update]
  get 'workout_class/get_workout_sessions', to: 'workout_class#get_workout_sessions'
